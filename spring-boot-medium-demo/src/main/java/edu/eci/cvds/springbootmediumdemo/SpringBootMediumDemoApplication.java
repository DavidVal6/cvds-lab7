package edu.eci.cvds.springbootmediumdemo;
...
import edu.eci.cvds.springbootmediumdemo.model.Employee;
import edu.eci.cvds.springbootmediumdemo.service.EmployeeService;

@SpringBootApplication
public class SpringBootMediumDemoApplication {

	@Autowired
	EmployeeService employeeService;

	public static void main(String[] args) {
		SpringApplication.run(SpringBootMediumDemoApplication.class, args);
	}
