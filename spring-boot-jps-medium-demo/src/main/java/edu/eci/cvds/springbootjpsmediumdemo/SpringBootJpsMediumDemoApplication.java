...
import edu.eci.cvds.springbootjpsmediumdemo.model.*;

@SpringBootApplication
public class SpringBootJpsMediumDemoApplication {

	@Autowired
	EmployeeService employeeService;

	public static void main(String[] args) {
		SpringApplication.run(SpringBootJpsMediumDemoApplication.class, args);
	}
